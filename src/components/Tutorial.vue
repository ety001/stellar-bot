    ...
    <el-col :span="20" :offset="2">
      <div>
        ...
        <ol class=" list-paddingleft-2" style="list-style-type: decimal;">
            <li>
              <p>
                第一次访问，需要增加你的钱包信息，这些信息可以从你的本地钱包中找到，如下图，
              </p>
              <p>
                <img src="//ww1.sinaimg.cn/large/7169dad9ly1fhtv8f4x68j20zw0sy14p.jpg" title="" alt="" width="500" height=""/>
              </p>
              <p>
                在『1』的位置是你的钱包地址，点击『1』，在新页面中『2』的位置是私钥，网关地址请使用RippleFox的网关，『GAREELUB43IRHWEASCFBLKHURCGMHE5IF6XSE7EXDLACYHGRHM43RFOX』。
              </p>
            </li>
            <li>
              <p>
              ...
              <p>
                <img src="//ww1.sinaimg.cn/large/7169dad9ly1fhtv8kqafzj20r80rmwhz.jpg" width="500" height="" title="" alt=""/>
              </p>
              <p>
      ...
      <div id="SOHUCS" sid="stellarbot"></div>
    </el-col>
  </el-row>
</template>
<script>
export default {
  ...
  mounted () {
    (function(){
    var appid = 'cyt82VAsa';
    var conf = 'prod_ff6336d3a1416c527929be3ad50b1b8a';
